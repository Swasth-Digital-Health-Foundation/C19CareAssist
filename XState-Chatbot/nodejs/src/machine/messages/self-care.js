let messages = {
  ...
  reportSelectPerson: {
    prompt: {
      ...
      // TODO: translated form google, replaced with custom translation
      te_IN: 'దయచేసి మీరు డౌన్‌లోడ్ చేయాలనుకుంటున్న రోగిని ఎంచుకోండి',
    },
  },
  vitalsSpo2: {
    prompt: {
      ...
      //TODO: Translated from google, replace with original
      te_IN: '{{name}}! దయచేసి ఆక్సిమీటర్ కోసం వెతకండి, మీ వేలికి అడుగు పెట్టండి మరియు సంఖ్యను స్థిరీకరించండి. ఇప్పుడు మీ పల్స్ ఆక్సిమీటర్ పరిమాణం ఎంత అని చెప్పు?',
    },
  },
  vitalsPulse: {
    prompt: {
      ...
      //TODO: Translated (Both kn and te) from google, replace with original
      kn_IN: 'ನಿಮ್ಮ ನಾಡಿಮಿಡಿತ ಏನು? (ನಾಡಿ ಆಕ್ಸಿಮೀಟರ್‌ನಲ್ಲೂ ಕಂಡುಬರುತ್ತದೆ)',
      te_IN : 'మీ పల్స్ ఏమిటి? (పల్స్ ఆక్సిమీటర్‌లో కూడా చూడవచ్చు)',
    },
  },
  vitalsBreathing: {
    prompt: {
  ...
  exitProgram: {
    exitPersonSelection: {
      prompt: {
        ...
        // TODO: Translated with google, replace with original
        te_IN: 'దయచేసి మీరు ఎవరి ప్రోగ్రామ్‌ను ముగించాలనుకుంటున్నారో రోగిని ఎంచుకోండి: \n\n',
      },
    },
    exitReason: {
      prompt: {
