let messages = {
  ...
  vitalsSpo2: {
    prompt: {
      ...
      pu_IN: "{{name}}! ਕਿਰਪਾ ਕਰਕੇ ਆਕਸੀਮੀਟਰ ਦੀ ਭਾਲ ਕਰੋ, ਇਸ ਨੂੰ ਆਪਣੀ ਉਂਗਲ 'ਤੇ ਪਾਓ ਅਤੇ ਨੰਬਰ ਨੂੰ ਸਥਿਰ ਹੋਣ ਦਿਓ. ਹੁਣ ਮੈਨੂੰ ਦੱਸੋ ਕਿ ਤੁਹਾਡੇ ਨਬਜ਼ ਦਾ ਆਕਸੀਮੀਟਰ ਕੀ ਕਹਿੰਦਾ ਹੈ?",
      as_IN: "{{name}}! অনুগ্ৰহ কৰি অক্সিমিটাৰটো বিচাৰক, ইয়াক আপোনাৰ আঙুলিত ৰাখক আৰু নম্বৰটো স্থিৰ হ'বলৈ দিয়ক। এতিয়া মোক কওঁক আপোনাৰ পালচ অক্সিমিটাৰে কি কয়",
      ur_IN: '{{name}}! مجھے امید ہے راہل کہ آپ کے گھر میں پلس آکسی میٹر ہوگا۔ براہ مہربانی  SpO2 کی جانچ کریں اور مندرجہ ذیل میں سے ایک آپشن کا انتخاب کریں',
    },
  },
  vitalsPulse: {
    prompt: {
      ...
      pu_IN: 'ਤੁਹਾਡੀ ਨਬਜ਼ ਕੀ ਹੈ? (ਨਬਜ਼ ਦੇ ਆਕਸੀਮੀਟਰ ਤੇ ਵੀ ਵੇਖਿਆ ਗਿਆ)',
      as_IN: 'আপোনাৰ স্পন্দন কি? (লগতে পালচ অক্সিমিটাৰত দেখা যায়)',
      ur_IN: 'آپ کی پلس کیا ہے؟ (پلس آکسیمٹر پر بھی دیکھیں)',
    },
  },
  vitalsBreathing: {
    prompt: {
      ...
      pu_IN: 'ਤੁਹਾਡੇ ਸਾਹ ਦੀ ਦਰ ਕੀ ਹੈ? <link>',
      as_IN: 'আপোনাৰ উশাহ-নিশাহৰ হাৰ কিমান? <link>',
      ur_IN: 'آپ کی سانس لینے کی شرح کتنی ہے؟ <لنک>',
    },
  },
  vitalsSpo2Bad: {
  ...
  exitProgram: {
    exitPersonSelection: {
      prompt: {
        ...
        pu_IN: 'ਕਿਰਪਾ ਕਰਕੇ ਉਹ ਮਰੀਜ਼ ਚੁਣੋ ਜਿਸ ਦਾ ਪ੍ਰੋਗਰਾਮ ਤੁਸੀਂ ਖਤਮ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ: \n\n',
        as_IN: 'অনুগ্ৰহ কৰি আপুনি সমাপ্ত কৰিব বিচৰা ৰোগীক বাছনি কৰক: \n\n',
        ur_IN: 'براہ کرم اس مریض کا انتخاب کریں جس کا پروگرام آپ ختم کرنا چاہتے ہی: \n\nں',
      },
    },
    exitReason: {
      prompt: {
    ...
    unsubscribedSuccessfully: {
      ...
      pu_IN: 'ਮੈਂ ਤੁਹਾਨੂੰ ਹੁਣ ਪ੍ਰੋਗਰਾਮ ਤੋਂ ਹਟਾ ਦਿੱਤਾ ਹੈ. ਤੁਸੀਂ ਹਮੇਸ਼ਾਂ ਆ ਸਕਦੇ ਹੋ ਅਤੇ ਦੁਬਾਰਾ ਪ੍ਰੋਗਰਾਮ ਵਿਚ ਸ਼ਾਮਲ ਹੋ ਸਕਦੇ ਹੋ ਅਤੇ ਕਿਰਪਾ ਕਰਕੇ ਕਿਸੇ ਵੀ ਚਿੰਤਾਵਾਂ ਦੇ ਲਈ ਮੇਰੇ ਨਾਲ ਸੰਪਰਕ ਕਰਨਾ ਯਾਦ ਰੱਖੋ. COVID-19 ਅਤੇ ਨੇੜਲੇ ਦੇਖਭਾਲ ਦੀਆਂ ਸਹੂਲਤਾਂ ਬਾਰੇ ਵਧੇਰੇ ਜਾਣਕਾਰੀ ਇੱਥੇ ਉਪਲਬਧ ਹੈ www.liferesources.in',
      as_IN: "মই এতিয়া আপোনাক প্ৰ'গ্ৰামৰ পৰা আঁতৰাই দিছো। আপুনি সদায়ে আহি পুনৰ কাৰ্যসূচীত যোগদান কৰিব পাৰে আৰু অনুগ্ৰহ কৰি যিকোনো উদ্বেগৰ বাবে মোৰ সৈতে যোগাযোগ কৰিবলৈ মনত ৰাখিব। কোভিড-19 আৰু ওচৰৰ যত্ন সুবিধাসম্পৰ্কে অধিক তথ্য ইয়াত উপলব্ধ আছে www.liferesources.in",
      ur_IN: 'میں نے اب آپ کو پروگرام سے ہٹا دیا ہے۔ آپ ہمیشہ آسکتے ہیں اور دوبارہ پروگرام میں شامل ہوسکتے ہیں اور براہ کرم کسی بھی مدد کے لئے مجھ سے رابطہ کرنا یاد رکھیں۔COVID-19 اور قریبی دیکھ بھال کی سہولیات کے بارے میں مزید معلومات یہاں دستیاب ہیں www.liferesources.in',
    },
  },
};
