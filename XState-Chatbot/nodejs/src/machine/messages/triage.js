let messages = {
  ...
  endFlow: {
    ...
    precautionEnd: {
      ...
      //TODO: Translated by google, replace with original
      kn_IN: "* {{name}}, ನಿಮ್ಮ ವಯಸ್ಸು / ಕೊಮೊರ್ಬಿಡಿಟಿಗಳನ್ನು ಗಮನದಲ್ಲಿಟ್ಟುಕೊಂಡು ನೀವು ಎಚ್ಚರಿಕೆಯಿಂದಿರಬೇಕು. * ಆರೋಗ್ಯವಾಗಿರಲು ಈ ಸರಳ ಸಲಹೆಗಳನ್ನು ಅನುಸರಿಸಲು ನಾನು ಸಲಹೆ ನೀಡುತ್ತೇನೆ !! \ n- ಬಾಯಿ ಮತ್ತು ಮೂಗು ಎರಡನ್ನೂ ಒಳಗೊಂಡ N95 ಮುಖವಾಡವನ್ನು ಧರಿಸಿ \ n- 7-8 ಗಂಟೆಗಳ ಕಾಲ ನಿದ್ರೆ ಮಾಡಿ ದಿನ \ n- ಹೈಡ್ರೀಕರಿಸಿದಂತೆ ಉಳಿಯಲು ದ್ರವಗಳನ್ನು ಕುಡಿಯಿರಿ \ n- ಆಲ್ಕೋಹಾಲ್ ಮತ್ತು ಧೂಮಪಾನವನ್ನು ತಪ್ಪಿಸಿ \ n- ಯೋಗವನ್ನು ಅಭ್ಯಾಸ ಮಾಡಿ ಮತ್ತು ಧ್ಯಾನ ಮಾಡಿ \ n CO n COVID-19 ಮತ್ತು ಹತ್ತಿರದ ಆರೈಕೆ ಸೌಲಭ್ಯಗಳ ಬಗ್ಗೆ ಹೆಚ್ಚಿನ ಮಾಹಿತಿ ಇಲ್ಲಿ ಲಭ್ಯವಿದೆ www.liferesources.in",
