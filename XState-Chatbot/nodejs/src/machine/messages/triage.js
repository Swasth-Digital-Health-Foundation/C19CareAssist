let messages = {
  personName: {
    ...
    error: {
      en_IN:
        "I am sorry, I didn't understand. Please enter a valid name which is less than 100 characters.",
      hi_IN:
        "माफ करें, मुझे समझ में नहीं आया।   नीचे दिए गए विकल्पों में से चुनें।",
      ta_IN:
        "மன்னிக்கவும், எனக்குப் புரியவில்லை. தயவு செய்து 100 கேரக்டர்களுக்குள் பயரை பதிவிடவும்.",
      ma_IN:
        "मला माफ करा, मला समजले नाही. कृपया एखादे वैध नाव प्रविष्ट करा 100 संख्या टाकू नये",
    },
  },
  personAge: {
    prompt: {
    ...
    error: {
      en_IN:
        "I am sorry, I didn't understand. Please enter a valid age (between 0 and 120)",
      hi_IN:
        "माफ करें, मुझे समझ में नहीं आया। कृपया 0 से 120 के बीच में अपनी आयु डालें",
      ta_IN:
        "என்னை மன்னித்து விடுங்கள். எனக்கு புரியவில்லை. உங்களது சரியான வயதை கொடுங்கள் (0 முதல் 120 வரை)",
      ma_IN:
        "मला माफ करा, मला समजले नाही. कृपया वैध वय प्रविष्ट करा (0 ते १२०  दरम्यान)",
    },
  },
  personGender: {
    prompt: {
  ...
  comorbidity: {
    prompt: {
      male: {
        ...
        hi_IN:
          "क्या आपको निम्नलिखित में से एक या एक से अधिक लक्षण हैं ? \n- मधुमेह(डायबिटीज) \n- उच्च रक्तचाप \n- फेफड़े सम्बंधी रोग \n- हृदय(दिल) रोग \n- मोटापा \n- गर्भवती",
        ta_IN:
          "இந்த நிலைகளில் ஒன்று அல்லது அதற்கு மேற்பட்டவை உங்களிடம் உள்ளதா? \n- நீரிழிவு நோய்\n- உயர் இரத்த அழுத்தம் (உயர் பிபி)\n- நாள்பட்ட நுரையீரல் நோய்\n- நோயெதிர்ப்பு குறைபாடுள்ள நிலை\n- இருதய நோய்\n- உடல் பருமன்",
        ma_IN:
          "आपल्याकडे यापैकी एक किंवा अधिक व्याधी / अटी आहेत?\n- मधुमेह  \n- उच्च रक्तदाब (उच्च बीपी)\n- दीर्घ काळ  फुफ्फुसाचा आजार\n- इम्युनोकोमप्रोम्ड आरोग्य \n- हृदय रोग\n- लठ्ठपणा /स्थूल पण ",
      },
      female: {
        en_IN:
          "Do you have one or more of these conditions? \n- Diabetes\n- Hypertension (High BP)\n- Chronic lung disease\n- Immunocompromised state\n- Heart disease\n- Obesity\n- Pregnancy\n",
  ...
  endFlow: {
    ageConsultDoctorEnd: {
      en_IN:
        "{{name}}, your age poses an additional risk factor! It would be best, if you consulted a doctor right away so that you can undergo tests if required and start the right medication. \nMore information regarding COVID-19 and nearby care facilities is available here https://life.coronasafe.network",
      hi_IN:
        "{{name}}, आपके उम्र के कारण आपको ज़्यादा ध्यान रखना होगा! अच्छा होगा अगर आप तुरंत डॉक्टर से मिलें ताकि वह ज़रूरी टेस्ट कराकर आपका सही इलाज शुरू कर सकें। \n COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहाँ उपलब्ध है https://life.coronasafe.network",
      ta_IN:
        "{{name}}, உங்கள் வயது ஒரு கூடுதல் ஆபத்து காரணியாகும்! நீங்கள் உடனடியாக ஒரு மருத்துவரை அணுகினால், தேவையான சோதனைகளுக்கு உட்பட்டு சரியான சிகிச்சைகளைத் தொடங்கலாம். COVID-19 மற்றும் அருகிலுள்ள பராமரிப்பு வசதிகள் பற்றிய கூடுதல் தகவல்கள் இங்கே கிடைக்கின்றன https://life.coronasafe.network",
      ma_IN:
        "{{name}}, तुझे वय एक जोखीम घटक आहे. आपण त्वरित एखाद्या डॉक्टरांचा सल्ला घेतल्यास हे चांगले होईल की आपण आवश्यक चाचण्या करून योग्य औषधे सुरू करू शकता. कोविड -१९  आणि   काळजी जवळील सुविधांविषयी अधिक माहिती येथे उपलब्ध आहे. https://life.coronasafe.network",
    },
    symptomComorbidConsultDoctorEnd: {
      en_IN:
        "*{{name}} your current symptoms along with your other medical condition(s) may need professional medical attention.* It would be best, if you consulted a doctor right away so that you can undergo the necessary tests and start the right medication.\n\nMore information regarding COVID-19 and nearby care facilities is available here https://life.coronasafe.network",
      hi_IN:
        "*{{name}} आपके लक्षण और सेहत की स्थिति देखकर लगता है की आपको चिकित्सा की ज़रुरत है.* कृपया तुरंत डॉक्टर की सलाह लें ताकि टेस्ट कराकर आपका सही इलाज शुरू किया जा सके. \n COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहां उपलब्ध है https://life.coronasafe.network",
      ta_IN:
        "ராகுல், உங்கள் தற்போதைய மருத்துவ அறிகுறிகளுடன் உங்கள் மற்ற மருத்துவ நிலைகளுக்கு முறையான  மருத்துவ கவனிப்பு தேவைப்படலாம்.\n நீங்கள் இப்போதே ஒரு மருத்துவரை அணுகினால் நல்லது, இதனால் நீங்கள் தேவையான சோதனைகளுக்கு உட்பட்டு சரியான சிகிச்சைகளைத் தொடங்கலாம்.\n COVID-19 மற்றும் அருகிலுள்ள பராமரிப்பு வசதிகள் பற்றிய கூடுதல் தகவல்கள் இங்கே கிடைக்கின்றன https://life.coronasafe.network",
      ma_IN:
        "राहुल, तुमची इतर लक्षणे आणि इतर वैद्यकीय स्थिती (त) यांनाही व्यावसायिक वैद्यकीय सहाय्याची आवश्यकता असू शकते.* आपण त्वरित एखाद्या डॉक्टरांचा सल्ला घेतल्यास हे चांगले होईल जेणेकरून आपण आवश्यक चाचण्या करून योग्य औषधे सुरू करू शकाल.\n\nकोविड -१९  आणि जवळील सुविधांविषयी अधिक माहिती येथे उपलब्ध आहे. https://life.coronasafe.network/",
    },
    testComorbidConsultDoctorEnd: {
      en_IN:
        "*{{name}} your test result along with your other medical condition(s) may need professional medical attention.* \nIt would be best if you  consulted a doctor so that you can undergo the necessary tests if required and start the right medications.\n\nMore information regarding COVID-19 and nearby care facilities is available here https://life.coronasafe.network",
      hi_IN:
        "*{{name}} आपके पॉजिटिव रिपोर्ट और अन्य स्वास्थ्य समस्याओं के कारण आपके सेहत को ज़्यादा खतरा है।* कृपया तुरंत डॉक्टर की सलाह लें! \n COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहां उपलब्ध है https://life.coronasafe.network",
      ta_IN:
        "*{{name}} உங்கள் பிற மருத்துவ நிலைகள் உடனான உங்கள் சோதனை முடிவுக்கு முறையான மருத்துவ கவனிப்பு தேவைப்படலாம்.* \nநீங்கள் ஒரு மருத்துவரை அணுகினால் நல்லது. தேவைப்பட்டால் அவசியமான சோதனைகளுக்கு உட்பட்டு சரியான சிகிச்சைகளைத் தொடங்கலாம். \nCOVID-19 மற்றும் அருகிலுள்ள பராமரிப்பு வசதிகள் பற்றிய கூடுதல் தகவல்கள் இங்கே கிடைக்கின்றன https://life.coronasafe.network",
      ma_IN:
        "*{{name}} आपल्या चाचणी निकालासह आपल्या इतर वैद्यकीय स्थिती ला व्यावसायिक वैद्यकीय लक्ष देण्याची आवश्यकता असू शकते.* \nआपण एखाद्या डॉक्टरांचा सल्ला घेतल्यास हे चांगले होईल जेणेकरून आवश्यक असल्यास आपण आवश्यक चाचण्या करून योग्य औषधे सुरू करू शकता.\nकोविड -१९  आणि जवळील सुविधांविषयी अधिक माहिती येथे उपलब्ध आहे. https://life.coronasafe.network/",
    },
    precautionEnd: {
      en_IN:
        "*{{name}}, given your age/comorbidities you should exercise caution.* I suggest following these simple tips to stay healthy!!\n- Wear N95 mask covering both mouth and nose\n- Sleep for 7-8 hours a day\n- Drink fluids to stay hydrated\n- Avoid alcohol and smoking\n- Practise yoga and meditate\n\nMore information regarding COVID-19 and nearby care facilities is available here https://life.coronasafe.network",
      hi_IN:
        "*{{name}}, आपके जवाबों से लगता नहीं है की आपको COVID-19 है स्वस्थ रहने के लिए इन सुझावों का पालन करें!* \n- N95 मास्क पहनें जो मुंह और नाक दोनों को कवर करे \n- दिन में 7-8 घंटे की नींद लें \n- तरल पदार्थों का सेवन करें \n- शराब और धूम्रपान छोड़ दें \n- योग और ध्यान करें \n \n  COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहां उपलब्ध है https://life.coronasafe.network",
      ta_IN:
        "*{{name}}, உங்கள் வயது / கொமொர்பிடிட்டிகளைப் பொறுத்தவரை நீங்கள்  மிகவும் எச்சரிக்கையாக இருக்க வேண்டும்.* \nஆரோக்கியமாக இருக்க இந்த எளிய உதவிக்குறிப்புகளைப் நீங்கள் பின்பற்ற பரிந்துரைக்கிறேன்! \n*வாய் மற்றும் மூக்கு இரண்டையும் உள்ளடக்கிய N95 மாஸ்க்கை அணியுங்கள்\n- ஒரு நாளைக்கு 7-8 மணி நேரம் தூங்குங்கள் \n- உடலில் நீர்ச்சத்து இருக்க திரவங்களை குடியுங்கள்\n- மது மற்றும் புகைப்பழக்கத்தை தவிருங்ககள்\n- யோகா பயிற்சி மற்றும் தியானம் செய்யுங்கள்\n ( இது தொடர்பாக மேலும் அறிய https://www.youtube.com/watch?v=TRxmzpg8Xfg \n https://www.youtube.com/watch?v=fXpnPYuswtI என்ற இந்த லிங்கை கிளிக் செய்யவும்) \nகொரோனா தொடர்பான தகவல்கள் மற்றும் அருகிலுள்ள பராமரிப்பு வசதிகள் பற்றிய கூடுதல் விவரங்கள் தெரிந்து கொள்ள https://life.coronasafe.network இதனை கிளிக் செய்யவும்",
      ma_IN:
        "{{name}}, तुमचे वय /अल्पवयीनतेने तुम्ही सावधगिरी बाळगली पाहिजे.\n- तुम्ही  निरोगी राहण्यासाठी या सोप्या सूचनांचे अनुसरण करण्यास सुचवितो!\n- तोंड आणि नाक दोन्ही झाकून एन 95 चा मुखवटा घाला\n- ७  दिवसा ७ - ८  तास झोप\n- हायड्रेटेड राहण्यासाठी द्रव प्या\n- दारू आणि धूम्रपान टाळा\nयोगाचा सराव करा आणि ध्यान करा (अधिक जाणून घेण्यासाठी येथे क्लिक करा: https://www.youtube.com/watch?v=TRxmzpg8Xfg\nhttps://www.youtube.com/watch?v=fXpnPYuswtI ",
    },
    noCovidEnd: {
      en_IN:
        "*{{name}}, based on your responses, it is less likely that you are suffering from COVID-19.* I suggest following these simple tips to stay healthy!\n- Wear an N95 mask covering both mouth and nose\n- Sleep for 7-8 hrs a day\n- Drink fluids to stay hydrated.\n- Avoid alcohol and smoking.\n5. Practise yoga and meditate.\n\nMore information regarding COVID-19 and nearby care facilities is available here  https://life.coronasafe.network",
      hi_IN:
        "*{{name}}, आपके जवाबों से लगता नहीं है की आपको COVID-19 है स्वस्थ रहने के लिए इन सुझावों का पालन करें!* \n- N95 मास्क पहनें जो मुंह और नाक दोनों को कवर करे \n- दिन में 7-8 घंटे की नींद लें \n- तरल पदार्थों का सेवन करें \n- शराब और धूम्रपान छोड़ दें \n- योग और ध्यान करें \n\n COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहां उपलब्ध है https://life.coronasafe.network",
      ta_IN:
        "*{{name}}, உங்கள் பதில்களின் அடிப்படையில், நீங்கள் கோவிட் -19 நோயால் பாதிக்கப்படுவது குறைவு.* ஆரோக்கியமாக இருக்க இந்த எளிய உதவிக்குறிப்புகளைப் பின்பற்ற பரிந்துரைக்கிறேன்! \n வாய் மற்றும் மூக்கு இரண்டையும் உள்ளடக்கிய N95 முகக் கவசத்தை அணியுங்கள் ஒரு நாளைக்கு 7-8 மணி நேரம் தூங்குங்கள் வறட்சியை தடுக்க திரவங்களாக குடிக்கவும் மது மற்றும் புகைப்பதைத் தவிர்க்கவும் யோகா பயிற்சி மற்றும் தியானம் மேற்கொள்ளவும் \n\nCOVID-19 மற்றும் அருகிலுள்ள பராமரிப்பு வசதிகள் பற்றிய கூடுதல் தகவல்கள் இங்கே கிடைக்கின்றன https://life.coronasafe.network",
      ma_IN:
        "{{name}}, तुमच्या प्रतिसादावर आधारित, तुम्ही कोविड -१९   पासून पीडित असण्याची शक्यता कमी आहे.\n- मी निरोगी राहण्यासाठी या सोप्या सूचनांचे अनुसरण करण्यास सुचवितो!\n- तोंड आणि नाक दोन्ही झाकून एन 95 चा मुखवटा घाला\n- ७  दिवसा ७ - ८  तास झोप\n- हायड्रेटेड राहण्यासाठी द्रव प्या\n- दारू आणि धूम्रपान टाळा\n- योगाचा सराव करा आणि ध्यान करा\nयोगाचा सराव करा आणि ध्यान करा (अधिक जाणून घेण्यासाठी येथे क्लिक करा: https://www.youtube.com/watch?v=TRxmzpg8Xfg\nhttps://www.youtube.com/watch?v=fXpnPYuswtI ",
    },
    lowSpo2End: {
      en_IN:
        "*{{name}}, your current oxygen level is below the normal value. Please consult a doctor right away!* \nMore information regarding COVID-19 is available here https://life.coronasafe.network",
      hi_IN:
        "*{{name}}, आपका वर्तमान ऑक्सीजन स्तर सामान्य मूल्य से नीचे है। कृपया तुरंत डॉक्टर से सलाह लें!* \n COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहाँ उपलब्ध है https://life.coronasafe.network",
      ta_IN:
        "*{{name}}, உங்கள் தற்போதைய ஆக்ஸிஜன் அளவு சாதாரண மதிப்பை விட குறைவாக உள்ளது. தயவுசெய்து உடனே ஒரு மருத்துவரை அணுகவும்!* \nCOVID-19 மற்றும் அருகிலுள்ள பராமரிப்பு வசதிகள் பற்றிய கூடுதல் தகவல்கள் இங்கே கிடைக்கின்றன https://life.coronasafe.network",
      ma_IN:
        "{{name}}, तुमची सध्याची ऑक्सिजन पातळी सामान्य मूल्यापेक्षा खाली आहे. कृपया त्वरित डॉक्टरांचा सल्ला घ्या!\nकोविड -१९  आणि जवळील सुविधांविषयी अधिक माहिती येथे उपलब्ध आहे. https://life.coronasafe.network",
    },
    noOximeterEnd: {
      en_IN:
        "{{name}}, your oxygen level is one of the most important parameters to gauge the severity of your condition. *Please order a pulse oximeter right away.* \nSend me a message when you have it so we can begin monitoring your vitals.",
      hi_IN:
        "{{name}}, आपका ऑक्सीजन स्तर आपकी स्थिति की गंभीरता का पता लगाने के लिए सबसे महत्वपूर्ण मापदंडों में से एक है। *कृपया तुरंत एक पल्स ऑक्सीमीटर की व्यवस्था करें* \n जब आपके पास यह हो तो मुझे संदेश भेजें ताकि हम आपके विटल्स की निगरानी शुरू कर सकें",
      ta_IN:
        "{{name}}, உங்கள் ஆக்ஸிஜன் அளவு உங்கள் உடல் நிலையின் தீவிரத்தை அறிய மிக முக்கியமான அளவுகோலில் ஒன்றாகும். *தயவுசெய்து ஒரு நாடித் துடிப்பு ஆக்சிமீட்டரை உடனடியாக ஆர்டர் செய்யவும்* \nஆக்சிமீட்டர் வாங்கிய பிறகு எனக்கு ஒரு மெசேஜ் அனுப்புங்கள், இதன்மூலம் உங்கள் உடல்நிலையை கண்காணிக்க ஆரம்பிக்கலாம்.",
      ma_IN:
        "{{name}}, आपल्या स्थितीची तीव्रता मोजण्यासाठी आपले ऑक्सिजन पातळी सर्वात महत्वाचे मापदंड आहे. कृपया आत्ताच पल्स ऑक्सिमीटरची व्यवस्था/मागणी करा\nआपल्याकडे हा संदेश असल्यास मला पाठवा जेणेकरुन आम्ही आपल्या निरीक्षण करण्यास सुरवात करू.",
    },
    walkTestEnd: {
      en_IN:
        "*{{name}}, this is an unexpected reaction to the walk test.* Please consult a doctor right away. \n\nMore information regarding COVID-19 and nearby care facilities is available here https://life.coronasafe.network",
      hi_IN:
        "*{{name}}, यह वॉक टेस्ट की अप्रत्याशित प्रतिक्रिया है। कृपया तुरंत डॉक्टर से सलाह लें।* \n COVID-19 और नज़दीकी देखभाल सुविधाओं के बारे में अधिक जानकारी यहाँ उपलब्ध है https://life.coronasafe.network",
      ma_IN:
        "*{{name}}, ही  चाचणीची एक अनपेक्षित प्रतिक्रिया आहे.* कृपया त्वरित डॉक्टरांचा सल्ला घ्या.\nकोविड -१९  आणि जवळील सुविधांविषयी अधिक माहिती येथे उपलब्ध आहे. https://life.coronasafe.network",
    },
    specialSymptomsEnd: {
      en_IN:
        "{{name}}, current symptoms require urgent medical attention. Please get in touch with your healthcare provider or visit a hospital emergency room immediately so that you can undergo appropriate testing and start the right medication. \n\n Information regarding nearby COVID-19 care facilities is also available here: https://life.coronasafe.network",
      hi_IN:
        "{{name}}, आपके लक्षणों के चलते आप को तुरंत इलाज की ज़रुरत है | कृपया तुरंत अपने डॉक्टर से संपर्क करें या नज़दीकी हस्पताल के इमरजेंसी विभाग में जाएं | \n {{name}} आपके लक्षण काफी गंभीर हैं, तुरंत डॉक्टर से मिलें या नज़दीकी अस्पताल में जाए ताकि टेस्ट कराकर आपका सही इलाज शुरू किया जा सके| \n COVID-19 से सम्बंधित जानकारी और नज़दीकी देखभाल की सुविधाओं के लिए कृपया https://life.coronasafe.network वेबसाइट पर जाएं |",
      ta_IN:
        "{{name}}, உங்களது இந்த தற்போதைய அறிகுறிகளுக்கு அவசர மருத்துவ சிகிச்சை தேவை. தயவுசெய்து உங்கள் சுகாதார அதிகாரிகளை தொடர்பு கொள்ளுங்கள் அல்லது உடனடியாக ஒரு மருத்துவமனையில் அவசர பிரிவுக்குச் செல்லுங்கள். இதன் மூலம் நீங்கள் தகுந்த பரிசோதனைக்கு உட்படுத்தப்பட்டு சரியான மருந்துகளைத் தொடங்கலாம். அருகிலுள்ள COVID-19 பராமரிப்பு வசதிகள் பற்றிய தகவல்களும் இங்கே கிடைக்கின்றன: https://life.coronasafe.network",
      ma_IN:
        "{{name}}, तुमच्या सध्याच्या लक्षणांवर तातडीने वैद्यकीय मदत घेण्याची गरज आहे. कृपया आपल्या आरोग्य सेवा प्रदात्याशी संपर्क साधा किंवा तत्काळ हॉस्पिटलच्या आपत्कालीन कक्षास भेट द्या जेणेकरून आपण योग्य चाचणी घेऊ शकता आणि योग्य औषधे सुरू करू शकता.\n\nजवळपास असलेल्या कोविड -१९  care केअर सुविधांविषयी माहिती देखील येथे उपलब्ध आहे: https://life.coronasafe.network",
    },
  },
  triageSpo2: {
    prompt: {
      preamble: {
        en_IN:
          "I hope you have a pulse oximeter at home, {{name}}. Please check your SpO2 and select an option from below",
        hi_IN:
          "मुझे उम्मीद है कि आपके पास घर पर एक पल्स ऑक्सीमीटर है, {{name}}। कृपया अपना SpO2 जांचें और नीचे से एक विकल्प चुनें",
        ta_IN:
          "நீங்கள் வீட்டில் நாடித்துடிப்பு அறியும் ஆக்சிமீட்டர் வைத்திருப்பீர்கள் என்று நம்புகிறேன் {{name}}. உங்கள் SpO2 ஐ சரிபார்த்து, கீழே இருந்து ஒரு விருப்பத்தைத் தேர்ந்தெடுக்கவும்",
        ma_IN:
          "मला आशा आहे की {{name}},  तुझ्या घरी  ऑक्सिमीटर असेल. कृपया आपला एसपीओ २  तपासा आणि खालील मधून एक पर्याय निवडा",
      },
      options: {
    ...
    normalSpo2: {
      en_IN:
        "*Your SpO2 is well within the normal range! This is a good sign! :)*",
      hi_IN: "*आपका SpO2 सामान्य सीमा के भीतर है! यह एक अच्छा संकेत है! :)*",
      ta_IN:
        "உங்கள் SpO2 நன்றாக சாதாரண அளவிற்குள் உள்ளது! இது ஒரு நல்ல அறிகுறி!",
    ...
    prompt: {
      ...
      options: {
        ...
        messageBundle: {
          below93: {
            en_IN:
              "SpO2 fell below 93 or reduced by 3 points or more (at any point during the test)",
            hi_IN:
              "SpO2 93 से नीचे गिर गया या 3 अंक या उससे कम हो गया (परीक्षण के दौरान कभी भी)",
            ma_IN:
              "एसपीओ२  ९३  च्या खाली आला किंवा ३ पेक्ष्या ज्यास्त   गुणां  हून  कमी झाला (चाचणीच्या वेळी)",
          },
          lightHeaded: {
