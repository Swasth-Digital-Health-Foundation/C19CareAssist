let messages = {
      ...
      options: {
        ...
        messageBundle: {
          ...
          selfCare: {
            ...
            hi_IN:
              "मैं अपने आप ही COVID-19 संक्रमण पर ध्यान रखना चाहता/चाहती हूं",
          ...
          info: {
            ...
            ta_IN:
              "கொரோனா பாதுகாப்பு மையங்கள் பற்றிய தகவல்களை நான் விரும்புகிறேன்",
  ...
  triageMenu: {
    prompt: {
      preamble: {
        en_IN:
          "Let me try and address them! Tell me more about your concerns...",
        hi_IN:
          "आप हमें अपनी समस्याओं के बारे में बताएं, हम आपकी चिंता दूर करने की कोशिश करेंगे",
        ta_IN:
          "நான் முயற்சி செய்து அவை குறித்து சொல்கிறேன்! உங்கள் கவலைகளைப் பற்றி மேலும் சொல்லுங்கள்...",
        ma_IN:
          "मी प्रयत्न करू आणि त्यांना संबोधित करू! मला तुमच्या चिंतांबद्दल अधिक सांगा ...",
      },
      options: {
        ...
        messageBundle: {
          ...
          doctorAdvise: {
            ...
            ta_IN:
              "வீட்டில் இருந்தே கோவிட் பராமரிப்பு மேற்கொள்ளும் ஆலோசனைகளை எனது மருத்துவர் வழங்கியுள்ளார்",
            ma_IN:
              "माझ्या डॉक्टरांनी कोविड व्यवस्थापनासाठी होमकेअरचा सल्ला दिला आहे",
          },
        },
      },
    },
